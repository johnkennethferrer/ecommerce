	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 p-0" style="margin:auto;">
				<h3 class="p-3 text-center">Your account is inactive. You need to verify you account before you login.</h3>
				<h4 class="p-3 text-center">Check you gmail account for verification.</h4>
