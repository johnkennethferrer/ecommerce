                        ...
                        @if(Auth::check())
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item text-secondary d-block" href="/user/customer_profile"><i class="fa fa-user"></i> My profile</a>
                                    <a class="dropdown-item text-secondary d-block" href="/user/customer_orders"><i class="fa fa-list"></i> My orders</a> 
                                    <a class="dropdown-item text-secondary" href="/user/customer_logout"><i class="fa fa-power-off"></i> Logout</a>   
                                </div>
                            </li>
                        @else
                            <li class="nav-item">
